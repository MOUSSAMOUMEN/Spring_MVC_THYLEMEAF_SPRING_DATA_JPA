package ma.enset.projecthospital.security;
...
public class securityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                .formLogin() // Configuration de la connexion via le formulaire
                .and()
                .authorizeRequests() // Configuration des autorisations des requêtes
